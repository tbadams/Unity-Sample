...
//		Debug.Log("remains is "+remains);
    ...
    /// </summary>
    void Update () {
//		Debug.Log("Update: Paused-" + isPaused+" start-"+start+" finish-"+
//			finish+" remains-"+remains+" passed-"+passed+" duration-"+duration+
//			" time-"+Time.time);
        if (!isPaused){
            remains = finish - Time.time;
            passed = duration - remains;
...
//				Debug.Log("PostUpdate: Paused-" + isPaused+" start-"+start+" finish-"+
//			finish+" remains-"+remains+" passed-"+passed+" duration-"+duration+
//			" time-"+Time.time);
    }
}